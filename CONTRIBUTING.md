...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/Data-Validate-IP).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Data-Validate-IP)
or [via email](bug-data-validate-ip@rt.cpan.org.
...
template file originating in Dist-Zilla-PluginBundle-DROLSKY-0.59.
